...
import org.sakaiproject.nakamura.webdav.SlingLocatorMapper;

public class SlingLocatorFactory implements DavLocatorFactory {

    private final String workspaceName;
    private SlingLocatorMapper locatorMapper;

    public SlingLocatorFactory(String workspaceName, SlingLocatorMapper locatorMapper) {
    ...
    public DavResourceLocator createResourceLocator(String prefix, String href) {
        ...
        System.err.println("Locator Mapper is "+locatorMapper);
        return new SlingResourceLocator(prefix, workspaceName, locatorMapper.mapPath(resourcePath),
            this);
    }
    ...
    public DavResourceLocator createResourceLocator(String prefix,
        ...
        return createResourceLocator(prefix, workspacePath, locatorMapper.mapPath(resourcePath), true);
    }
    ...
    public DavResourceLocator createResourceLocator(String prefix,
        ...
        return new SlingResourceLocator(prefix, workspacePath, locatorMapper.mapPath(resourcePath),
            this);
    }
