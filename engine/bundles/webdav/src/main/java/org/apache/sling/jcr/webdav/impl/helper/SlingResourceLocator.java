...
class SlingResourceLocator implements DavResourceLocator {
    ...
    SlingResourceLocator(String prefix, String workspaceName,
        ...
        href = buf.toString();
        LoggerFactory.getLogger(SlingResourceLocator.class).info("Creating resource Locator prefix:[{}] workspace:[{}] resourcepath:[{}] href:[{}] ",new Object[] {prefix,workspaceName, resourcePath, href});
    }
