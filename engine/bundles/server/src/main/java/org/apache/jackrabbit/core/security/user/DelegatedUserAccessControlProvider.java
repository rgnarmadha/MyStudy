 ...
 * </ul>
 */
public class DelegatedUserAccessControlProvider extends AbstractAccessControlProvider
     ...
     *
     */
    public DelegatedUserAccessControlProvider() {
            ...
            if (Text.isDescendant(usersPath, jcrPath)) {
                ...
                */
                ...
                // Start Nakamura Change               
                   ...
                   privs = PrivilegeRegistry.NO_PRIVILEGE;
                   log.debug("Denied all to {} ", node.getPath());
                 } else {
