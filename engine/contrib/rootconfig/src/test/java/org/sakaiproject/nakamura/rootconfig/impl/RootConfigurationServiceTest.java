...
import static org.sakaiproject.nakamura.rootconfig.impl.RootConfigurationService.PROP_SLING_REDIRECT_TARGET;
import static org.sakaiproject.nakamura.rootconfig.impl.RootConfigurationService.PROP_SLING_REDIRECT_TYPE;
...
import org.sakaiproject.nakamura.rootconfig.impl.RootConfigurationService;
...
public class RootConfigurationServiceTest {
  private RootConfigurationService rootConfigurationService;
  ...
  public void setup() throws Exception {
    ...
    rootConfigurationService = new RootConfigurationService();
    rootConfigurationService.repository = repository;
  }

  @Test
  public void doNothingIfBlankProperties() throws RepositoryException {
    rootConfigurationService.activate(new HashMap<String, String>());
  ...
  public void changeRedirectPath() throws RepositoryException {
    ...
    props.put(RootConfigurationService.ROOT_PATH, "/joe");
    rootConfigurationService.activate(props);
  ...
  @Test
  public void changeEvenIfNotRedirectNode() throws RepositoryException {
    when(rootNode.getProperty(SLING_RESOURCE_TYPE_PROPERTY).getString()).thenReturn("wrong:one");
    HashMap<String, String> props = new HashMap<String, String>();
    props.put(RootConfigurationService.ROOT_PATH, "/joe");
    rootConfigurationService.activate(props);
    verify(rootNode).setProperty(SLING_RESOURCE_TYPE_PROPERTY, PROP_SLING_REDIRECT_TYPE);
    verify(rootNode).setProperty(PROP_SLING_REDIRECT_TARGET, "/joe");
  }
