...
public class OpenSsoAuthenticationPluginTest {
  OpenSsoAuthenticationPlugin plugin;

  @Mock
  OpenSsoLoginModulePlugin loginModulePlugin;
  ...
  @Before
  public void setUp() {
    plugin = new OpenSsoAuthenticationPlugin(loginModulePlugin);
  }
