...
public class OpenSsoLoginServlet extends SlingAllMethodsServlet {
  ...
  @Reference
  private OpenSsoAuthenticationHandler ssoAuthnHandler;
  ...
  protected void service(SlingHttpServletRequest request,
    ...
    if (request.getAuthType() != null) {
      AuthenticationInfo authnInfo = (AuthenticationInfo) request
          .getAttribute(OpenSsoAuthenticationHandler.AUTHN_INFO);
      if (authnInfo != null) {
        OpenSsoAuthenticationTokenServiceWrapper tokenServiceWrapper = new OpenSsoAuthenticationTokenServiceWrapper(
