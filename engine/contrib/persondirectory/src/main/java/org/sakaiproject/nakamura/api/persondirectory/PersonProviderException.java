...
public class PersonProviderException extends Exception {
  ...
  public PersonProviderException() {
    super();
  }

  public PersonProviderException(String message, Throwable cause) {
    super(message, cause);
  }

  public PersonProviderException(String message) {
    super(message);
  }

  public PersonProviderException(Throwable cause) {
    super(cause);
  }
