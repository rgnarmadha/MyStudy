...
public class CasAuthenticationPluginTest {
  CasAuthenticationPlugin plugin;

  @Mock
  CasLoginModulePlugin loginModulePlugin;
  ...
  @Before
  public void setUp() {
    plugin = new CasAuthenticationPlugin(loginModulePlugin);
  }
