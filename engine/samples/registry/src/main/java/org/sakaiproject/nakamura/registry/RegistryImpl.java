...
import org.sakaiproject.nakamura.api.registry.RegistryListener;
...
public class RegistryImpl<V, T extends Provider<V>> implements Registry<V, T> {
   ...
   * {@inheritDoc}
   *
   * @see org.sakaiproject.nakamura.api.Registry#add(java.lang.Object)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.sakaiproject.nakamura.api.Registry#remove(java.lang.Object)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.sakaiproject.nakamura.api.Registry#getMap()
   */
  ...
  /**
   * {@inheritDoc}
   * @see org.sakaiproject.nakamura.api.Registry#addListener(org.sakaiproject.nakamura.api.RegistryListener)
   */
  ...
  /**
   * {@inheritDoc}
   * @see org.sakaiproject.nakamura.api.Registry#removeListener(org.sakaiproject.nakamura.api.RegistryListener)
   */
